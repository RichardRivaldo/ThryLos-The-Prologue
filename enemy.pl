...
createGoblin(1) :-      asserta(enemy(goblin)),
                        ...
                        asserta(attack(goblin,3)),
                        asserta(specialattack(goblin,5)),
...
createGoblin(2) :-      asserta(enemy(goblin)),
                        ...
                        asserta(specialattack(goblin,7)),
...
createGoblin(3) :-      asserta(enemy(goblin)),
                        ...
                        asserta(specialattack(goblin,9)),
...
createApex    :-        asserta(enemy(apex)),
                        ...
                        asserta(specialattack(zool,32)),
                        asserta(defense(apex,24)),
