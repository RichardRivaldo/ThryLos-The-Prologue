...
createSlime(3) :-       asserta(enemy(slime)),
                        ...
                        asserta(attack(slime,8)),
                        asserta(specialattack(slime,9)),
...
createGoblin(1) :-      asserta(enemy(goblin)),
                        ...
                        asserta(attack(goblin,5)),
                        asserta(specialattack(goblin,6)),
...
createGoblin(2) :-      asserta(enemy(goblin)),
                        ...
                        asserta(attack(goblin,7)),
                        asserta(specialattack(goblin,8)),
...
createGoblin(3) :-      asserta(enemy(goblin)),
                        ...
                        asserta(attack(goblin,9)),
                        asserta(specialattack(goblin,10)),
...
createSpider(1) :-      asserta(enemy(spider)),
                        ...
                        asserta(specialattack(spider,8)),
...
createSpider(2) :-      asserta(enemy(spider)),
                        ...
                        asserta(specialattack(spider,10)),
...
createSpider(3) :-      asserta(enemy(spider)),
                        ...
                        asserta(specialattack(spider,12)),
...
createZool(1) :-        asserta(enemy(zool)),
                        asserta(health(zool,20)),
                        asserta(attack(zool,15)),
                        asserta(specialattack(zool,16)), 
                        asserta(defense(zool,13)),
...
createZool(2) :-        asserta(enemy(zool)),
                        asserta(health(zool,23)),
                        asserta(attack(zool,17)),
                        asserta(specialattack(zool,18)),
                        asserta(defense(zool,15)),
                        asserta(speed(zool,14)),
                        asserta(goldEarned(zool,160)),
                        asserta(expEarned(zool,115)),
                        asserta(isDead(no)).

createZool(3) :-        asserta(enemy(zool)),
                        asserta(health(zool,26)),
                        asserta(attack(zool,19)),
                        asserta(specialattack(zool,20)),
                        asserta(defense(zool,17)),
                        asserta(speed(zool,16)),
...
createApex    :-        asserta(enemy(apex)),
                        ...
                        asserta(attack(apex,30)),
                        asserta(specialattack(apex,32)),
                        asserta(defense(apex,28)),
                        asserta(speed(apex,22)),
                        asserta(goldEarned(apex,0)),
                        asserta(expEarned(apex,0)),
...
dungeon       :-        asserta(isBattle(yes)),
                        write('Entering dungeon.... time to test your capability!'),nl,
                        write('.'),nl,
                        write('.'),nl,
                        write('.'),nl,
                        write('.'),nl,
